...
if(isset($_POST['update']))
{
	...
	$result=mysqli_query($x,"UPDATE info SET name='$name',std='$std',mark='$mark',fees='$fees', bal='$bal',password='$password' WHERE std=$std");
...
<body>
	<a href="principalbackend2.php">home</a>
	<br>
	<form name="form1" method="POST" action="edit1.php">
		<table border="0">
			...
			<tr>
				<td><input type="hidden" name="std" value="<?php echo $_GET['std'];?>"></td>
